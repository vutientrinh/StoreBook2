<%-- 
    Document   : error500
    Created on : Dec 5, 2023, 11:49:46 PM
    Author     : Admin
--%>
...
<html lang="en">
    <head>
        ...
        <title>ERROR DE 505 UwU</title>
    </head>
    <body>
        <a href="${pageContext.request.contextPath}/view/edit_page.jsp" target="_blank" style = "text-decoration: none;">
